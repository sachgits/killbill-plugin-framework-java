 ...
 * under the License.
 * RegisterURLRequest tested and working very well
 */
...
public class RegisterURLRequest {
    ...
    public RegisterURLRequest(final int shortCode, final String confimationUrl, final String validationUrl) {
        ShortCode = shortCode;
        ConfirmationURL = confimationUrl;
        ValidationURL = validationUrl;
        ResponseType = String.valueOf(4);
    }
